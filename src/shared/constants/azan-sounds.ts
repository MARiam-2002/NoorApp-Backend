...
export const NOTIFICATION_SOUND_OPTIONS: NotificationSoundOption[] = [
  ...
  // ================================================================
  // Prayer-event short Arabic clips — assets/prayer-events/ only.
  // Used by Flutter local scheduling for PRE/AZAN short voices + FRIDAY/DUHA/QIYAM.
  // NOT full Adhan (those remain under assets/azan/).
  // ================================================================
  {
    id: 'sc_event_fajr',
    nameEn: 'Fajr event voice',
    nameAr: 'صوت حدث الفجر',
    descriptionEn: 'Short Arabic clip for Fajr local prayer events.',
    descriptionAr: 'مقطع عربي قصير لحدث صلاة الفجر.',
    audioUrl: '',
    previewUrl: '',
    mediaFile: 'sc_event_fajr.mp3',
    format: 'mp3',
    provider: 'soundcloud_reference',
    source: 'Noor prayer-event pack',
    mood: 'prayer_event_voice',
    matchesPrayer: 'FAJR',
    matchesEvent: 'FAJR',
    durationSeconds: null,
    license: {
  ...
  {
    id: 'sc_event_dhuhr',
    nameEn: 'Dhuhr event voice',
    nameAr: 'صوت حدث الظهر',
    descriptionEn: 'Short Arabic clip for Dhuhr local prayer events.',
    descriptionAr: 'مقطع عربي قصير لحدث صلاة الظهر.',
    audioUrl: '',
    previewUrl: '',
    mediaFile: 'sc_event_dhuhr.mp3',
    format: 'mp3',
    provider: 'soundcloud_reference',
    source: 'Noor prayer-event pack',
    mood: 'prayer_event_voice',
  ...
  {
    id: 'sc_event_asr',
    nameEn: 'Asr event voice',
    nameAr: 'صوت حدث العصر',
    descriptionEn: 'Short Arabic clip for Asr local prayer events.',
    descriptionAr: 'مقطع عربي قصير لحدث صلاة العصر.',
    audioUrl: '',
    previewUrl: '',
    mediaFile: 'sc_event_asr.mp3',
    format: 'mp3',
    provider: 'soundcloud_reference',
    source: 'Noor prayer-event pack',
    mood: 'prayer_event_voice',
  ...
  {
    id: 'sc_event_maghrib',
    nameEn: 'Maghrib event voice',
    nameAr: 'صوت حدث المغرب',
    descriptionEn: 'Short Arabic clip for Maghrib local prayer events.',
    descriptionAr: 'مقطع عربي قصير لحدث صلاة المغرب.',
    audioUrl: '',
    previewUrl: '',
    mediaFile: 'sc_event_maghrib.mp3',
    format: 'mp3',
    provider: 'soundcloud_reference',
    source: 'Noor prayer-event pack',
    mood: 'prayer_event_voice',
    matchesPrayer: 'MAGHRIB',
    matchesEvent: 'MAGHRIB',
    durationSeconds: null,
    license: {
      spdxOrName: 'none',
      licenseUrl: null,
  ...
  {
    id: 'sc_event_isha',
    nameEn: 'Isha event voice',
    nameAr: 'صوت حدث العشاء',
    descriptionEn: 'Short Arabic clip for Isha local prayer events.',
    descriptionAr: 'مقطع عربي قصير لحدث صلاة العشاء.',
    audioUrl: '',
    previewUrl: '',
    mediaFile: 'sc_event_isha.mp3',
    format: 'mp3',
    provider: 'soundcloud_reference',
    source: 'Noor prayer-event pack',
    mood: 'prayer_event_voice',
  ...
  {
    id: 'sc_event_jumuah',
    nameEn: 'Friday / Jumuah event voice',
    nameAr: 'صوت حدث الجمعة',
    descriptionEn: 'Short Arabic clip for FRIDAY local events (not a sixth daily prayer).',
    descriptionAr: 'مقطع عربي قصير لحدث الجمعة (ليس صلاة يومية سادسة).',
    audioUrl: '',
    previewUrl: '',
    mediaFile: 'sc_event_jumuah.mp3',
    format: 'mp3',
    provider: 'soundcloud_reference',
    source: 'Noor prayer-event pack',
    mood: 'prayer_event_voice',
  ...
  {
    id: 'sc_event_duha',
    nameEn: 'Duha event voice',
    nameAr: 'صوت حدث الضحى',
    descriptionEn: 'Short Arabic clip for DUHA local events (separate from the five daily prayers).',
    descriptionAr: 'مقطع عربي قصير لحدث الضحى (منفصل عن الصلوات الخمس).',
    audioUrl: '',
    previewUrl: '',
  ...
  {
    id: 'sc_event_qiyam',
    nameEn: 'Qiyam event voice',
    nameAr: 'صوت حدث قيام الليل',
    descriptionEn: 'Short Arabic clip for QIYAM local events (separate from the five daily prayers).',
    descriptionAr: 'مقطع عربي قصير لحدث قيام الليل (منفصل عن الصلوات الخمس).',
    audioUrl: '',
    previewUrl: '',
