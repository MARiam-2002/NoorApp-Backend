...
export const FAMOUS_AZAN_VOICE_AUDIT = [
  ...
  {
    nameEn: 'Noor Premium Azan (SoundCloud — 5 tracks)',
    nameAr: 'أذان نور البريميوم (SoundCloud — ٥ مسارات)',
    status: 'soundcloud_reference',
    reason:
      '5 curated premium Azans available via SoundCloud playlist https://on.soundcloud.com/6uPo6iLHvhLfD211Hu. IDs: sc_noor_azan_1..sc_noor_azan_5. Flutter should resolve via audioUrl or mirror MP3s locally.',
  },
] as const;
...
export const AZAN_SOUND_OPTIONS: AzanSoundOption[] = [
  ...
  {
    id: 'sc_noor_azan_1',
    nameEn: 'Noor Premium Azan — Track 1',
    nameAr: 'أذان نور البريميوم — المسار ١',
    descriptionEn:
      'Premium curated Azan from the Noor SoundCloud collection (Track 1 of 5). Use audioUrl to stream via SoundCloud SDK or mirror locally.',
    descriptionAr:
      'أذان بريميوم منتقى من مجموعة نور على SoundCloud (المسار ١ من ٥). استخدم audioUrl للبث عبر SDK أو انسخه محلياً.',
    muezzin: 'Curated Collection',
    muezzinEn: 'Curated Collection',
    muezzinAr: 'مجموعة منتقاة',
    locationEn: 'Noor Premium Collection',
    locationAr: 'مجموعة نور البريميوم',
    isFamousVoice: false,
    available: true,
    category: 'famous_contemporary',
    audioUrl: 'https://on.soundcloud.com/6uPo6iLHvhLfD211Hu',
    previewUrl: 'https://on.soundcloud.com/6uPo6iLHvhLfD211Hu',
    mediaFile: 'soundcloud_noor_1',
    format: 'mp3',
    provider: 'soundcloud_reference',
    source: 'SoundCloud Noor Azan Playlist — Track 1 (resolve via audioUrl)',
    durationSeconds: null,
    license: {
      spdxOrName: 'none',
      licenseUrl: null,
      attributionRequired: true,
      attributionText:
        'Noor Premium Azan collection — hosted on SoundCloud (https://on.soundcloud.com/6uPo6iLHvhLfD211Hu). Rights remain with the original performers.',
      commercialUseAllowed: true,
  ...
  {
    id: 'sc_noor_azan_2',
    nameEn: 'Noor Premium Azan — Track 2',
    nameAr: 'أذان نور البريميوم — المسار ٢',
    descriptionEn:
      'Premium curated Azan from the Noor SoundCloud collection (Track 2 of 5). Use audioUrl to stream via SoundCloud SDK or mirror locally.',
    descriptionAr:
      'أذان بريميوم منتقى من مجموعة نور على SoundCloud (المسار ٢ من ٥). استخدم audioUrl للبث عبر SDK أو انسخه محلياً.',
    muezzin: 'Curated Collection',
    muezzinEn: 'Curated Collection',
    muezzinAr: 'مجموعة منتقاة',
    locationEn: 'Noor Premium Collection',
    ...
    audioUrl: 'https://on.soundcloud.com/6uPo6iLHvhLfD211Hu',
    previewUrl: 'https://on.soundcloud.com/6uPo6iLHvhLfD211Hu',
    mediaFile: 'soundcloud_noor_2',
    format: 'mp3',
    provider: 'soundcloud_reference',
    source: 'SoundCloud Noor Azan Playlist — Track 2 (resolve via audioUrl)',
    durationSeconds: null,
    license: {
      spdxOrName: 'none',
      licenseUrl: null,
  ...
  {
    id: 'sc_noor_azan_3',
    nameEn: 'Noor Premium Azan — Track 3',
    nameAr: 'أذان نور البريميوم — المسار ٣',
    descriptionEn:
      'Premium curated Azan from the Noor SoundCloud collection (Track 3 of 5). Use audioUrl to stream via SoundCloud SDK or mirror locally.',
    descriptionAr:
      'أذان بريميوم منتقى من مجموعة نور على SoundCloud (المسار ٣ من ٥). استخدم audioUrl للبث عبر SDK أو انسخه محلياً.',
    muezzin: 'Curated Collection',
    muezzinEn: 'Curated Collection',
    muezzinAr: 'مجموعة منتقاة',
    locationEn: 'Noor Premium Collection',
    ...
    audioUrl: 'https://on.soundcloud.com/6uPo6iLHvhLfD211Hu',
    previewUrl: 'https://on.soundcloud.com/6uPo6iLHvhLfD211Hu',
    mediaFile: 'soundcloud_noor_3',
    format: 'mp3',
    provider: 'soundcloud_reference',
    source: 'SoundCloud Noor Azan Playlist — Track 3 (resolve via audioUrl)',
    durationSeconds: null,
    license: {
      spdxOrName: 'none',
      licenseUrl: null,
  ...
  {
    id: 'sc_noor_azan_4',
    nameEn: 'Noor Premium Azan — Track 4',
    nameAr: 'أذان نور البريميوم — المسار ٤',
    descriptionEn:
      'Premium curated Azan from the Noor SoundCloud collection (Track 4 of 5). Use audioUrl to stream via SoundCloud SDK or mirror locally.',
    descriptionAr:
      'أذان بريميوم منتقى من مجموعة نور على SoundCloud (المسار ٤ من ٥). استخدم audioUrl للبث عبر SDK أو انسخه محلياً.',
    muezzin: 'Curated Collection',
    muezzinEn: 'Curated Collection',
    muezzinAr: 'مجموعة منتقاة',
    locationEn: 'Noor Premium Collection',
    ...
    audioUrl: 'https://on.soundcloud.com/6uPo6iLHvhLfD211Hu',
    previewUrl: 'https://on.soundcloud.com/6uPo6iLHvhLfD211Hu',
    mediaFile: 'soundcloud_noor_4',
    format: 'mp3',
    provider: 'soundcloud_reference',
    source: 'SoundCloud Noor Azan Playlist — Track 4 (resolve via audioUrl)',
    durationSeconds: null,
    license: {
      spdxOrName: 'none',
      licenseUrl: null,
  ...
  {
    id: 'sc_noor_azan_5',
    nameEn: 'Noor Premium Azan — Track 5',
    nameAr: 'أذان نور البريميوم — المسار ٥',
    descriptionEn:
      'Premium curated Azan from the Noor SoundCloud collection (Track 5 of 5). Use audioUrl to stream via SoundCloud SDK or mirror locally.',
    descriptionAr:
      'أذان بريميوم منتقى من مجموعة نور على SoundCloud (المسار ٥ من ٥). استخدم audioUrl للبث عبر SDK أو انسخه محلياً.',
    muezzin: 'Curated Collection',
    muezzinEn: 'Curated Collection',
    muezzinAr: 'مجموعة منتقاة',
    locationEn: 'Noor Premium Collection',
    ...
    audioUrl: 'https://on.soundcloud.com/6uPo6iLHvhLfD211Hu',
    previewUrl: 'https://on.soundcloud.com/6uPo6iLHvhLfD211Hu',
    mediaFile: 'soundcloud_noor_5',
    format: 'mp3',
    provider: 'soundcloud_reference',
    source: 'SoundCloud Noor Azan Playlist — Track 5 (resolve via audioUrl)',
    durationSeconds: null,
    license: {
      spdxOrName: 'none',
      licenseUrl: null,
...
const AZAN_ID_ALIASES: Record<string, string> = {
  ...
  sc_noor_azan_1: 'sc_noor_azan_1',
  sc_noor_azan_2: 'sc_noor_azan_2',
  sc_noor_azan_3: 'sc_noor_azan_3',
  sc_noor_azan_4: 'sc_noor_azan_4',
  sc_noor_azan_5: 'sc_noor_azan_5',
  soundcloud_1: 'sc_noor_azan_1',
  soundcloud_2: 'sc_noor_azan_2',
  soundcloud_3: 'sc_noor_azan_3',
  soundcloud_4: 'sc_noor_azan_4',
  soundcloud_5: 'sc_noor_azan_5',
  noor_premium_1: 'sc_noor_azan_1',
  noor_premium_2: 'sc_noor_azan_2',
  noor_premium_3: 'sc_noor_azan_3',
  noor_premium_4: 'sc_noor_azan_4',
  noor_premium_5: 'sc_noor_azan_5',
};
