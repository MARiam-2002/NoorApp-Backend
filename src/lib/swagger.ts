                ...
                sadaqah: {
                  ...
                  properties: {
                    ...
                    goal: {
                      type: 'number',
                      example: 1000,
                      description: 'هدف الصدقة اليومي (additive, backward-compatible)',
                    },
                    percent: {
                      type: 'number',
                      example: 35,
                      description: 'نسبة التقدم نحو الهدف (additive)',
                    },
                    currency: { type: 'string', example: 'EGP' },
                    currencyLabelAr: { type: 'string', example: 'جنيه' },
                    currencyLabelEn: { type: 'string', example: 'EGP' },
                  },
                },
              },
            },
